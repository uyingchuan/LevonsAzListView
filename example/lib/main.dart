...
import 'package:levons_azlistview/levons_azlistview.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Levons AzListView Demo Home Page'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  final List<AzListItem<String>> azListData = [];
